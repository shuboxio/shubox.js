    ...
    function Shubox (selector) {
      ...
      for (var index = 0; index < els.length; ++index) {
        ...
        if ('INPUT' === el.tagName || 'TEXTAREA' === el.tagName) {
          this.options = mergeObject(this.options, this.defaultOptions, this.formOptions, {})
          this.callbacks = mergeObject(this.callbacks, this.defaultCallbacks, this.formCallbacks)
        }else {
          this.options = mergeObject(this.options, this.defaultOptions, {})
          this.callbacks = mergeObject(this.callbacks, this.defaultCallbacks)
        }
